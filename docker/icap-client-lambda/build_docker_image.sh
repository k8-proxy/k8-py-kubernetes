...
curl -XPOST "http://localhost:9000/2015-03-31/functions/function/invocations" -d '{"command":"/usr/local/c-icap/bin/c-icap-client","params":["-i","54.171.103.144"]}'
